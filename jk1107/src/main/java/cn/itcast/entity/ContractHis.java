...
public class ContractHis {
	private Set<ContractProductHis> contractProductHiss;
	public Set<ContractProductHis> getContractProductHiss() {
		return contractProductHiss;
	}
	public void setContractProductHiss(Set<ContractProductHis> contractProductHiss) {
		this.contractProductHiss = contractProductHiss;
	}
