...
public class ExtCproductHis {
	...
	private ContractProductHis contractProductHis;
	
	public ContractProductHis getContractProductHis() {
		return contractProductHis;
	}
	public void setContractProductHis(ContractProductHis contractProductHis) {
		this.contractProductHis = contractProductHis;
	}
