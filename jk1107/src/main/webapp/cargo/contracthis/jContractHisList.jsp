...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('/contracthis/contractHisAction_toview','_self');this.blur();">查看</a></li>
<li id="delete"><a href="#" onclick="formSubmit('/contracthis/contractHisAction_delete','_self');this.blur();">删除</a></li>
</ul>
    </div>
</div>
</div>
...
<input id="btnFind" type="button" name="btnFind" value="查询" onclick="formSubmit('/contracthis/contractHisAction_list','_self');this.blur();">
...
<div>
	...
	<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
		...
		<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
			...
			<td>
				<s:property value="contractProductHiss.size()"/>
				/
				<s:set var="extNumber" value="0"/>
				<s:iterator value="contractProductHiss" var="cp">
					<s:set var="extNumber" value="#extNumber + #cp.extCproductHiss.size()"/>
				</s:iterator>
