...
<head>
	...
	<script type="text/javascript" src="../js/ajax/recordOnlineState.js"></script>
...
<script language="javascript">
	...
	function CustomTitle(){
		...
		Me.onmouseover = function(){document.getElementById('memo').style.background='url(/skin/default/images/title/memo2.gif) no-repeat'};
		Me.onmouseout = function(){document.getElementById('memo').style.background='url(/skin/default/images/title/memo.gif) no-repeat'};
		...
		Lout.onmouseover = function(){document.getElementById('small_login_out').style.background='url(/skin/default/images/title/login_out2.gif) no-repeat left -55px;'};
		Lout.onmouseout = function(){document.getElementById('small_login_out').style.background='url(/skin/default/images/title/login_out.gif) no-repeat'};
	}
	...
	function linkHighlightMenu(obj){
		...
		obj.style.background ='url("/skin/default/images/title/button_bg.jpg") no-repeat';
		obj.style.color = "#fff";                                                                                                                                                                                                                                                   
...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			return formSubmit("../index.jsp", "_top");
		}
</script>
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	...
	<a id="memos"  style="cursor:pointer;" href="../home/fmain.jsp" target="_top" title="点击切换到系统首页"><div id="memo" class="memo" title="点击切换到系统首页"></div></a>
	    ...
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
						...
						onclick="top.leftFrame.location.href='/cargo/left.jsp';top.main.location.href='/cargo/main.jsp';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span><span id="topmenu"
						onclick="top.leftFrame.location.href='/baseinfo/left.jsp';top.main.location.href='/baseinfo/main.jsp';;linkHighlightMenu(this);">基础信息</span><span id="tm_separator"></span><span id="topmenu" 
					...
					<span id="rightKey" onmouseover="periodOffset(this, 'right')"><img src="/skin/default/images/title/right_arrow.png"/></span>
				</div>
		</div>
	</div>
</div>

<div id="prompt_div"><img src="/skin/default/images/title/prompt.png"/><span style="position:absolute;top:2px;left:35px;z-index: 99999;width:100%;color:#FFFFFF;text-align: left; ">鼠标指向箭头位置<br/>可显示更多菜单项</span></div>
