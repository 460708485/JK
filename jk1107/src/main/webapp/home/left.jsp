		...
		<div class="sidebar_t_r"></div>
 	    ...
 	    <div class="panel">
	        ...
	        <a href="#" onmousemove="javascript:showMenu('customerMenu');">自定义菜单</a>
		        	...
		        	<div id="customerMenu">
		        	<div class="FastMenu"><img src="../skin/default/images/notice.gif" style="margin-right:5px;" border="0" /><font color="gray">您还没定义您的菜单</font></div>
		        	</div>
	        </div>
	    </div>
	 <div class="sidebar_t">
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
    	<div class="panel_icon"><img src="../skin/default/images/icon/businessman2.png" /></div>
        <div class="panel-header">
