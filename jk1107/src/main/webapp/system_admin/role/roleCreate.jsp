...
<head>
    ...
    <link rel="stylesheet" rev="stylesheet" type="text/css" href="../../js/dtree/tdtree/dtree.css" />
...
<div class="textbox">
    ...
    <div>
        <table class="commonTable" cellspacing="1" border="0">
	        <input  type="hidden"  name="id_create"  />
	        <tr>
	            <td class="columnTitle_mustbe">角色名称</td>
	            <td class="tableContentAuto"><input type="text" name="name" dataType="非空字符串" dispName="角色名称" maxLength="40" onchange="_CheckValidate(this)"/></td>
	            <td class="columnTitle">排序号</td>
	            <td class="tableContentAuto"><input type="text" name="orderNo" dataType="整数" dispName="排序号" maxLength="40"/></td>
	        </tr>
	        <tr>
	            <td class="columnTitle">角色描述</td>
	            <td class="tableContentAuto" colspan="3">
	            	<textarea id="textarea" onkeyup="getMaxlength('textarea');textareasize(this);" onmousemove ="getMaxlength('textarea');" onmouseout ="getMaxlength('textarea');" class="textarea" name="roleDesc" rows="3" dataType="字符串" dispName="角色描述" maxLength="100" onkeyup="textareasize(this)"></textarea>
	        	...
	        	<td class="tableContentAuto" colspan="3">
					<div id="Alldept" style="overflow:auto;height:120px;clear:both;">
						<ul>
								...
								<li title='组织机构'><input minSelect="0" class="input" type="checkbox" name="userId" value="001"/>调试</li>
								
							
								<li title='杰信商贸'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff808081307f4ffc01307f5ce342001f"/>管理员</li>
								
							
								<li title='杰信商贸'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf0131303ceab20031"/>吴杰</li>
								
							
								<li title='开发部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf0131303ed30a0035"/>刘晓</li>
								
							
								<li title='销售部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf0131303fe2e40038"/>王丽</li>
								<br>
							
								<li title='船务部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf01313040e6b7003b"/>张玉</li>
								
							
								<li title='财务部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf01313041a034003e"/>席军</li>
								
							
								<li title='杰信商贸'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf0131304334410041"/>殷丽茹</li>
								
							
								<li title='杰信商贸'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf01313043fd3e0044"/>杜勇</li>
								
							
								<li title='销售部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf01313044c2d00047"/>田燕</li>
								<br>
							
								<li title='销售部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf013130455a7c004a"/>吴梦熙</li>
								
							
								<li title='销售部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf013130492d100053"/>石宇秀</li>
								
							
								<li title='船务部'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff80808131301abf0131304ac5060058"/>杜娟丽</li>
								
							
								<li title='杰信商贸'><input minSelect="0" class="input" type="checkbox" name="userId" value="ff8080813d00613e013d006644a60003"/>演示</li>
